...
public class ListaAviso {
	...
	/**
	 * Determina a última senha que teve um aviso emitido. 
	 ...
	 * @throws ServletException Lançada se não for possível realizar os avisos da lista.
	 */
	 ...
	 * @throws ServletException Lançada se não for possível gravar no diretório raiz da aplicação.
	 */
