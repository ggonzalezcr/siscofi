...
public class Cor implements Comparable<Cor>{
	 ...
	 * @param valorCor Nome da cor.
	 * @return O nome da cor correspondente ao valor passado como parï¿½metro.
	 */
	public static String NomeValorCor(String valorCor){
		return mapaCor.get(valorCor.toUpperCase());
	}
	
	/**
	 * Determina o valor relacionado a um nome de cor.
	 * @param nomeCor O valor da cor.
	 * @return Valor correspondente ao nome da cor passado como parï¿½metro.
	 */
	public static String ValorNomeCor(String nomeCor){
		return mapaValor.get(nomeCor.toUpperCase());
	}
	
	/**
	 * Determina um conjunto contendo os nomes de todas as cores disponï¿½veis no sistema.
	 * @return Retorno um Set de cores disponï¿½veis no sistema.
	 */
