...
public class Formulario {
	...
	@Column(name="resposta1", nullable=true)
	private String resposta1;
	@Column(name="resposta2", nullable=true)
	private String resposta2;
	@Column(name="resposta3", nullable=true)
	private String resposta3;
	@Column(name="resposta4", nullable=true)
	private String resposta4;
	@Column(name="resposta5", nullable=true)
	private String resposta5;
	@Column(name="resposta6", nullable=true)
	private String resposta6;
	@Column(name="resposta7", nullable=true)
	...
	public static void main(String[] args) {
		...
		f.geraXMLDoFormulario();
		System.out.println(f.getQuestao5());
	}
}
