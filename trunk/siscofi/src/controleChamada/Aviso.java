...
//
//	/**
//	 * Modifica o estado do Aviso para já realizado, ou não não realizado.
//	 * 
//	 * @param avisar
//	 *            novo estado do aviso tem de ser igual a contante <b>AVISAR</b>
//	 *            ou a constante <b>NAO_AVISAR</b>.
//	 * @return True se o estado do aviso for modificado e False em caso
//	 *         contrário.
//	 */
//	public boolean setAvisar(String avisar) {
//		boolean isSetado = false;
//		if (avisar.equalsIgnoreCase(AVISAR)
//				|| avisar.equalsIgnoreCase(NAO_AVISAR)) {
//			this.avisar = avisar;
//			isSetado = true;
//		}
//		return isSetado;
