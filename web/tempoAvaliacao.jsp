...
<title>Coleta de Dados - Tempo Médio de Avaliacao</title>
...
function submeter(){
	if(document.TempoAtendimentoForm.quantidadePessoas.value < 0 || isNaN(document.TempoAtendimentoForm.quantidadePessoas.value)){
		...
		alert("O tempo médio para as avaliações não pode ser negativo!");
	} else{
...
<html:form action="/entregaTitulo.do?metodo=salvo">
  <h2>Coleta de dados do tempo de Avaliação do Atendiemnto</h2><br>
...
<p></p>
  	...
  	<p>Qual é o tempo médio para a avaliação do atendimento: <html:text property="tempoMedioAvaliacao" size="5" maxlength="5"></html:text></p>
  	<p>
