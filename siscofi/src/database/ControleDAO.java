...
//		controle.generateTable();
		System.out.println(controle.listaClasses());

		controle.generateTable();
		Controle c = new Controle();
		c.setClasse("Segunda Via");
		c.setPrefixo("SGV");
		c.setCor("FFFFFF");
		c.setQuantidadeInicial(10);
		controle.writeControle(c);
		System.out.println(controle.listaControles());
	}
