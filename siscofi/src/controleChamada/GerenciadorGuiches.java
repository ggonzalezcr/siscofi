...
public class GerenciadorGuiches extends TimerTask {
	 ...
	 * @param duracaoSessao O tempo máximo em minutos que um guichê pode ficar inativo.
	 */
	public GerenciadorGuiches(int duracaoSessao) {
