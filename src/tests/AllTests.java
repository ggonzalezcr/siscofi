...
public class AllTests {
	...
	public static Test suite() {
		...
		suite.addTestSuite(TestaAviso.class);
		suite.addTestSuite(TestaListaAviso.class);
		suite.addTestSuite(TestaConfiguracao.class);
		suite.addTestSuite(TestaConfigAvaliacaoForm.class);
		suite.addTestSuite(TestaConfigLoginForm.class);
		suite.addTestSuite(TestaGuiche.class);
		suite.addTestSuite(TestaGerenciadorGuiches.class);
		suite.addTestSuite(TestaEstatisticasDAO.class);
		suite.addTestSuite(TestaEstatisticas.class);
		suite.addTestSuite(TestaEstatisticaResposta.class);
		suite.addTestSuite(TestaGeradorGraficosAtendimentos.class);
		suite.addTestSuite(TestaGeradorQuestionarioPDF.class);
		suite.addTestSuite(TestaGeradorGraficosRelatorio.class);
		suite.addTestSuite(TestaGeradorGraficosRelatorioAvaliacao.class);
		suite.addTestSuite(TestaGeradorPDF.class);
		suite.addTestSuite(TestaMonitoramentoCentral.class);
