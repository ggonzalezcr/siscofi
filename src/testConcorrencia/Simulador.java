...
public class Simulador extends TimerTask{
	 ...
	 * @param tempo Tempo em milissegundos até que a simulação seja encerrada.
	 */
	 ...
	 * @param tempo tempo em milissegundos entre cada repetição
	 */
	...
	/**
	 * Adiciona uma tarefa que será executada apenas uma vez, após n milissegundos do momento da adição.
	 * @param tarefa Tarefa a ser repetida;
	 * @param tempo em milissegundos até a tarefa seja executada.
	 */
